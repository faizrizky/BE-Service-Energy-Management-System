...
const PERMISSIONS = [
  ...
  ['room', 'view'], ['room', 'create'], ['room', 'edit'], ['room', 'delete'], ['room', 'power_control'],
  ['device', 'view'], ['device', 'create'], ['device', 'edit'], ['device', 'delete'], ['device', 'power_control'],
  ['gateway', 'view'], ['gateway', 'create'], ['gateway', 'edit'], ['gateway', 'delete'],
...
async function main() {
  ...
  console.log('[Seed] Selesai. Akun admin default: username="admin", password="changeme123" (WAJIB diganti).');
}
